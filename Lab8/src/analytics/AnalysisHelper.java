...
public class AnalysisHelper {
    ...
    public void getAverageLikesPerComments() {
        ...
        System.out.println("----------**********----------");
        System.out.println("Average number of likes per comments: " + likeNumber / commentNumber); //Q1
        System.out.println("----------**********----------\n");    
    }
        ...
        System.out.println("----------**********----------");
        System.out.println("Post with most likes per comment: " + data.getPosts().get(postId).getPostId()); //Q2
        System.out.println("----------**********----------\n");
        ...
        public void getPostWithMostComments(){
                ...
                System.out.println("----------**********----------");
                System.out.println("Post with most Comments: "+ postWithMostComments.getPostId()); //Q3
                System.out.println("----------**********----------\n");
    ...
    public void getPassiveUsers(){
        ...
        System.out.println("--------------------********************--------------------");
        System.out.println("The following users have the least posts: ");//Q4
        System.out.println("--------------------********************--------------------");
        for (int i = 0; i<5; i++){
    ...
    public void getPassiveCommentsUsers(){
        ...
        System.out.println("--------------------********************--------------------");
        System.out.println("The following users have the least comments: ");//Q5
        System.out.println("--------------------********************--------------------");
        for (int i = 0; i<5; i++){
    ...
    public void getPassiveAndActiveOverallUsers(){
        ...
        System.out.println("--------------------********************--------------------");
        System.out.println("The following users are the passive overall: ");//Q6
        System.out.println("--------------------********************--------------------");
        for (int i = 0; i<5; i++){
        ...
        System.out.println("--------------------********************--------------------");
        System.out.println("The following users are the active overall: ");
        System.out.println("--------------------********************--------------------");
