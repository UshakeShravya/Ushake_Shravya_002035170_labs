...
public class LoginScreen extends javax.swing.JPanel {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (selectedPanel.getClass() == SupplierWorkAreaJPanel.class){
            if (selectedSupplier == null) {
                ...
                selectedPanel = new SupplierWorkAreaJPanel(mainWorkArea,supplierDirectory, selectedSupplier);
            }
        }
    ...
    private void populateRoleCombo() {
        ...
        SupplierWorkAreaJPanel supplierPanel = new SupplierWorkAreaJPanel(mainWorkArea,supplierDirectory, selectedSupplier);
