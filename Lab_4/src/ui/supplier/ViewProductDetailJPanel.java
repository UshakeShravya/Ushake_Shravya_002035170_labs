...
//        if(product.getProductImage() != null) imgLogo.setIcon(product.getProductImage());
//        else imgLogo.setText("No Logo");
        
//        tblFeatures.setEnabled(true);
//    tblFeatures.setRowSelectionAllowed(true);  // Allow row selection.
//    tblFeatures.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);  // Single row selection.

    // Add ListSelectionListener to track row selection
//    tblFeatures.getSelectionModel().addListSelectionListener(e -> {
...
//    });
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        tblFeatures.setRowSelectionAllowed(true);
